...
import { addUserIfNotExists } from "../_service/database-service";
          ...
          <div className="grow bg-gray-800 m-10 p-5 rounded-4xl w-auto h-10/12 flex flex-col">
            ...
            <div className="size-full">
              <div className="h-1/2 p-3">
                <button onClick={handleGitHubSignIn} className=" bg-white hover:bg-neutral-200 hover:cursor-pointer size-full text-center rounded-4xl">
              ...
              <div className="h-1/2 p-3 min-h-fit">
                <button onClick={handleGoogleSignIn} className=" bg-white hover:bg-neutral-200 hover:cursor-pointer size-full text-center rounded-4xl">
                  <div className="flex flex-row items-center justify-center size-full">
